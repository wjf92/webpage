  ...
  <div>
        ...
        <div class="edittable-testauto-con">
          <Form ref="formValidate" :model="formItem" :label-width="100" :rules="ruleInline">
            ...
            <Form-item label="数据库名称:" prop="dbname">
              <Input v-model="formItem.dbname" placeholder="请输入"></Input>
            </Form-item>
            ...
            <FormItem label="用于dbsearch:">
              <i-switch v-model="formItem.can_dbsearch" true-value="1" false-value="0"></i-switch>
            </FormItem>
    ...
    <Modal v-model="baseinfo" :width="500" okText="保存" @on-ok="update_base">
      ...
      <Form :label-width="100" label-position="right">
        ...
        <FormItem label="数据库名称:">
          <Input v-model="editbaseinfo.dbname"></Input>
        </FormItem>
        <FormItem label="用户名:">
        ...
        <FormItem label="用于dbsearch:">
          <i-switch v-model="editbaseinfo.can_search"></i-switch>
        </FormItem>
      </Form>
    </Modal>
  ...
  export default {
    ...
    methods: {
        ...
        this.$refs['formValidate'].validate((valid) => {
          if (valid) {
            let data = {
              ...
              'password': this.formItem.password,
              'port': this.formItem.port,
              'can_dbsearch': this.formItem.can_dbsearch
            }
      ...
      edit_tab (index) {
        ...
        this.editbaseinfo.can_search ? this.editbaseinfo.can_search = true : this.editbaseinfo.can_search = false
        console.log(this.editbaseinfo.can_search)
      },
      // 删除数据库
      deldatabases (index) {
